...
@javax.annotation.Generated(
    ...
    comments = "Source: llm-server.proto")
public final class LLMChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.crossnetcorp.chat.llmserver.LlmServer.PingRequest,
      com.crossnetcorp.chat.llmserver.LlmServer.PingResponse> getPingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ping",
      requestType = com.crossnetcorp.chat.llmserver.LlmServer.PingRequest.class,
      responseType = com.crossnetcorp.chat.llmserver.LlmServer.PingResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.crossnetcorp.chat.llmserver.LlmServer.PingRequest,
      com.crossnetcorp.chat.llmserver.LlmServer.PingResponse> getPingMethod() {
    ...
    if ((getPingMethod = LLMChatServiceGrpc.getPingMethod) == null) {
      synchronized (LLMChatServiceGrpc.class) {
        if ((getPingMethod = LLMChatServiceGrpc.getPingMethod) == null) {
          LLMChatServiceGrpc.getPingMethod = getPingMethod = 
              io.grpc.MethodDescriptor.<com.crossnetcorp.chat.llmserver.LlmServer.PingRequest, com.crossnetcorp.chat.llmserver.LlmServer.PingResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new LLMChatServiceMethodDescriptorSupplier("ping"))
                  .build();
          }
        }
     }
   ...
   */
  public static LLMChatServiceBlockingStub newBlockingStub(
   ...
   */
  public static LLMChatServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
  ...
  public static final class LLMChatServiceStub extends io.grpc.stub.AbstractStub<LLMChatServiceStub> {
    ...
    @java.lang.Override
    protected LLMChatServiceStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static final class LLMChatServiceBlockingStub extends io.grpc.stub.AbstractStub<LLMChatServiceBlockingStub> {
    ...
    @java.lang.Override
    protected LLMChatServiceBlockingStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  public static final class LLMChatServiceFutureStub extends io.grpc.stub.AbstractStub<LLMChatServiceFutureStub> {
    ...
    @java.lang.Override
    protected LLMChatServiceFutureStub build(io.grpc.Channel channel,
        io.grpc.CallOptions callOptions) {
  ...
  private static final class LLMChatServiceFileDescriptorSupplier
      extends LLMChatServiceBaseDescriptorSupplier {
    LLMChatServiceFileDescriptorSupplier() {}
  }

  private static final class LLMChatServiceMethodDescriptorSupplier
      extends LLMChatServiceBaseDescriptorSupplier
